                            ...
                            <form method="POST" action="../../negocio/Ng_tbl_denominacion.php">
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-control" id="moneda" name="moneda"
                                        title="Seleccione una Moneda" required>
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="valor" name="valor" type="text" title="Valor de la denominacion" value="<?php echo $denominacion->valor?>" required/>
                                    <label for="username">Valor</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="valorlet" name="valorlet" type="text" title="Valor en letras de la denominacion" value="<?php echo $denominacion->valor_letras?>" required/>
